...
export const FriendRequest = () => {
  ...
  const { friendRequests, handleManageFriendRequest } = useFriendRequests(
  ...
  const filteredRequests = friendRequests.filter(
    (request) => request.receiverId === authUser.id,
  );
            ...
            {filteredRequests.map((request) => (
              <li key={request._id} className="request-item">
                ...
                <div className="actions">
                  <button
                    onClick={() =>
                      handleManageFriendRequest(request._id, "accept")
                    }
                  >
                    Accept
                  </button>
                  <button
                    onClick={() =>
                      handleManageFriendRequest(request._id, "decline")
                    }
                  >
                    Decline
                  </button>
