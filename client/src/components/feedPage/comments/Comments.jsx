...
export const CommentsList = ({ postId }) => {
    const { comments, loading, handleDeleteComment, handleUpdateComment } = useGetAllComments(postId);
                                            ...
                                            <div className="comment-actions">
                                                {editCommentId === comment._id ? (
                                                    <>
                                                        ...
                                                        <button onClick={() => setEditCommentId(null)} className="cancel-button">
                                                            <FaTimes />
                                                        </button>
                                                    </>
                                                ) : (
                                                    <>
                                                        <button
                                                            onClick={() => handleEditComment(comment._id, comment.content.text)}
